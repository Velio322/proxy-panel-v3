              ...
              {menu && createPortal(
                <>
                  ...
                  >
                    ...
                    <button onClick={() => { onDelete(); setMenu(false); }} className="w-full px-3 py-1.5 text-left text-xs text-danger hover:bg-danger-muted/30 flex items-center gap-2.5 transition-colors font-semibold">
